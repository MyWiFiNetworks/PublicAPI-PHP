...
/**
 * AssignDevice Class Doc Comment
 *
 * @category Class
 * @package  GuestNetworks
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AssignDevice implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AssignDevice';
...
'device_id' => 'getDeviceId'    ];
     ...
     * Sets location_id
     *
     * @param int $location_id The Location ID (to disassociate a Device from any Location set the location_id to 0)
     *
     * @return $this
     */
     ...
     * Sets device_id
     *
     * @param int $device_id The Device ID to assign
     *
     * @return $this
     */
