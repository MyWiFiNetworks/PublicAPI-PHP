...
class AnalyticsApi
{
     ...
     * @param  string $agg The interval to group results by (optional)
     *
     * @throws \GuestNetworks\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function getSocialLogins($location_id, $start_date, $end_date, $agg = null)
    {
     ...
     */
    public function getSocialLoginsWithHttpInfo($location_id, $start_date, $end_date, $agg = null)
    {
        $returnType = '';
     ...
     */
    public function getSocialLoginsAsync($location_id, $start_date, $end_date, $agg = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSocialLoginsAsyncWithHttpInfo($location_id, $start_date, $end_date, $agg = null)
    {
        $returnType = '';
        $request = $this->getSocialLoginsRequest($location_id, $start_date, $end_date, $agg);
     ...
     */
    protected function getSocialLoginsRequest($location_id, $start_date, $end_date, $agg = null)
    {
     ...
     * @return void
     */
    public function getVisits($location_id, $start_date, $end_date, $agg = null)
    {
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function getVisitsWithHttpInfo($location_id, $start_date, $end_date, $agg = null)
    {
        $returnType = '';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getVisitsAsync($location_id, $start_date, $end_date, $agg = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getVisitsAsyncWithHttpInfo($location_id, $start_date, $end_date, $agg = null)
    {
        $returnType = '';
        $request = $this->getVisitsRequest($location_id, $start_date, $end_date, $agg);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getVisitsRequest($location_id, $start_date, $end_date, $agg = null)
    {
        // verify the required parameter 'location_id' is set
        if ($location_id === null || (is_array($location_id) && count($location_id) === 0)) {
            throw new \InvalidArgumentException(
